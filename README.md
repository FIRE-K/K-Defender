...
* Отсутствие активного вмешательства в выполнение бота.

---

## 5. Структура репозитория

> ⚠️ **Внимание:** структура репозитория на данный момент может изменяться.
>
> В документации намеренно **не фиксируется жёсткое дерево каталогов**, так как проект находится в активной разработке.

Данный раздел будет заполнен после стабилизации архитектуры и публичного релиза версии 1.0.
...
Для начала работы с ним требуется в Телеграмм найти бота под nickname: **@kdefender_bot** и нажать кнопку "Старт". После этого в боте будут предоставлены дальнейшие инструкции.
